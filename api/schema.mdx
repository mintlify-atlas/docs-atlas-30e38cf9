---
title: "Schema Exploration API — Browse & Search Tables"
sidebarTitle: "Schema"
description: "Discover, inspect, and semantically search the ERP database schema. List tables, retrieve column-level detail, and run FAISS-powered natural-language table search."
---
