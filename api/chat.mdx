---
title: "Chat API — POST /chat, GET /health, GET /metrics"
sidebarTitle: "Chat REST API"
description: "POST natural language questions to the ERP Financial Agent, handle HITL confirmation flows, and check service health and Prometheus metrics."
---
