---
title: "Docker Compose Local Setup for ERP Financial Agent"
sidebarTitle: "Docker"
description: "Run the full ERP Financial Agent stack locally: Docker Compose starts FastAPI on port 8000, the React/nginx frontend on port 5173, and Redis."
---
