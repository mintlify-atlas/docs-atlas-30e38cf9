---
title: "AWS ECS Fargate Deployment Guide"
sidebarTitle: "AWS ECS"
description: "Deploy ERP Financial Agent to AWS ECS Fargate using three CloudFormation stacks: network, services, and CI/CD. Includes ALB, ECR, auto-scaling, and GitHub Actions."
---
...
<Steps>
  ...
  <Step title="Build and push Docker images to ECR">
    After the services stack is deployed (step 4), ECR repositories will exist. You can also push manually before the first ECS deploy:
